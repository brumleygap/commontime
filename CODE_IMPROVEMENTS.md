...
- [x] **#4 4× duplicated recipient query** (`src/actions/polls.ts:187, 346, 407, 466`) — Identical 10-line `SELECT COALESCE(u.email, pa.email)` pasted into `lockPoll`, `cancelPoll`, `uncancelPoll`, `unlockPoll`. Extract to a shared helper.
